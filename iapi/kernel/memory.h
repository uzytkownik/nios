...
struct iapi_kernel_memory
{
  ...
  struct iapi_kernel_memory_pagedir *(*create_pageset)(struct iapi_kernel_memory *self);
...
{
  struct iapi iapi;
  size_t (*get_page_size)(struct iapi_kernel_memory_pageset *self);
  ...
  void (*unmap)(struct iapi_kernel_memory_pageset *self,
